...
#include <Adafruit_SSD1306.h>  // ЗАМЕНА: SH110X на SSD1306
...
void drawStandbyAnimation() {
  ...
  // ЗАМЕНА: SH110X_WHITE на SSD1306_WHITE
  display.drawBitmap(dvd_x, dvd_y, bitmap_dvd_logo, DVD_LOGO_WIDTH, DVD_LOGO_HEIGHT, SSD1306_WHITE);
...
void setup() {
  ...
  if (!SD.begin(-1, sdSPI)) {
    display.clearDisplay();
    // ЗАМЕНА: SH110X_WHITE на 1 (цвет белый в SSD1306)
