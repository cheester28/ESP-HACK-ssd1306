...
extern Adafruit_SSD1306 display;  // Изменено на Adafruit_SSD1306
...
extern void OLED_printMenu(Adafruit_SSD1306 &display, byte menuIndex);  // Изменено на Adafruit_SSD1306
...
void renderColorSetting() {
  ...
  display.setTextColor(SSD1306_WHITE);  // Изменено на SSD1306_WHITE
